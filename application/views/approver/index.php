                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <a href="<?php echo base_url('approver/c_approver/inbox_ss');?>">
                            <div class="box bg-info text-center">
                                <?php foreach($count->result() as $row) { ?>
                                <span class="badge badge-pill badge-light float-right" style="font-size: 16px;color:red;"><b>
                                <?php echo $row->jumlah_ss_approver; ?></b></span>
                                <?php } ?>
                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <a href="<?php echo base_url('approver/c_approver/inbox_opl');?>">
                            <div class="box bg-success text-center">
                                <?php foreach($count_jml_opl->result() as $row) { ?>
                                <span class="badge badge-pill badge-light float-right" style="font-size: 16px;color:red;"><b><?php echo $row->jumlah_ss_approver; ?></b></span>
                                <?php } ?>
                                <h1 class="font-light text-white"><i class="m-r-10 mdi mdi-inbox-arrow-down" style="padding-left:25pt;"></i></h1>

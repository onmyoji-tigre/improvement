            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">List Data Koreksi</h5>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            table = $('#example3').DataTable({ 
                ...
                "ajax": {
                    "url": "<?php echo site_url('member/c_member/ajax_list_correction')?>",
                    "type": "POST"
                },
        ...
        function save()
        {
            var url;
                ...
                url = "<?php echo site_url('member/c_member/ajax_correction_update')?>";

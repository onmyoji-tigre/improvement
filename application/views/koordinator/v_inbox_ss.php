                        ...
                        <div class="modal-body form">
                            <form action="#" id="form" class="form-horizontal">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row" style="margin-bottom: 1rem;">
                                        <div class="col-md-6">
                                            <label class="control-label col-md-12">Latar Belakang</label>
                                            <div class="input-group">
                                                <textarea name="LATAR_BELAKANG" class="form-control" rows="4" placeholder="Enter ..." readonly></textarea>
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="control-label col-md-12">Usulan Perbaikan</label>
                                            <div class="input-group">
                                                <textarea name="PERBAIKAN" class="form-control" rows="4" placeholder="Enter ..."  readonly></textarea>
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-bottom: 1rem;">
                                        <div class="col-md-6">
                                            <label class="control-label col-md-12">Target/Manfaat</label>
                                            <div class="input-group">
                                                <textarea name="MANFAAT" class="form-control" rows="4" placeholder="Enter ..."  readonly></textarea>
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <textarea name="ALAT_BAHAN" class="form-control" rows="4" placeholder="Enter ..."  readonly></textarea>
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-bottom: 1rem;">
                                        <div class="col-md-3">
                                        <label class="control-label col-md-12">Biaya</label>
                                            <input name="BIAYA" placeholder="BIAYA" class="form-control" type="text" readonly>
                                            <span class="help-block"></span>
                                        </div>
                                         <div class="col-md-3">
                                        <label class="control-label col-md-12">No WR</label>
                                            <input name="NO_WR" placeholder="NO_WR" class="form-control" type="text" readonly>
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Alasan Reject</label>
                                        <div class="input-group">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            table = $('#example3').DataTable({ 
                ...
                "ajax": {
                    "url": "<?php echo base_url('koordinator/c_koordinator/ajax_list')?>",
                    "type": "POST"
                },
        ...
        function edit_person(ID_IMPROVEMENT)
        {
            ...
            $.ajax({
                url : "<?php echo site_url('koordinator/c_koordinator/ajax_edit/')?>/" + ID_IMPROVEMENT,
                type: "GET",
                dataType: "JSON",
        ...
        {
            var url;
                url = "<?php echo site_url('koordinator/c_koordinator/ajax_update')?>";
        ...
        function reject()
        {
            var url;
                ...
                url = "<?php echo site_url('koordinator/c_koordinator/ajax_reject_ss')?>";

            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Reject</label>
                            <div class="input-group">
                                <textarea name="REJECT" id="REJECT" class="form-control" rows="3" placeholder="Enter ..." ></textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    table = $('#example3').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('koordinator/c_koordinator/ajax_list_opl_coordinator')?>",
            "type": "POST"
        },
...
function edit_person_opl(ID_OPL)
{
    ...
    $.ajax({
        url : "<?php echo site_url('koordinator/c_koordinator/ajax_coordinator_opl/')?>/" + ID_OPL,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    var url;
        ...
        url = "<?php echo site_url('koordinator/c_koordinator/ajax_update_opl_coordinator')?>";
...
function reject()
{
    ...
    var url;
        ...
        url = "<?php echo site_url('koordinator/c_koordinator/ajax_reject_opl_coordinator')?>";
    
        var koreksi = document.getElementById("REJECT").value;
        if (koreksi == "") {
            alert('Anda harus mengisi kolom reject !');
            $("#REJECT").focus();
            return false;
        }else{
    // ajax adding data to database
